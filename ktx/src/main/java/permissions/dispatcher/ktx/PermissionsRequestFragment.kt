...
internal class PermissionsRequestFragment : Fragment() {
    private val requestCodeTable = mutableMapOf<String, Int>()
    ...
    fun requestPermissions(permissions: Array<out String>, requiresPermission: Func,
        ...
        val requestCode = currentCode.getAndIncrement()
        requestPermissions(permissions, requestCode)
        requestCodeTable[permissions.joinToString()] = requestCode
    }

    override fun onRequestPermissionsResult(requestCode: Int, permissions: Array<String>, grantResults: IntArray) {
        if (requestCode == requestCodeTable[permissions.joinToString()]) {
